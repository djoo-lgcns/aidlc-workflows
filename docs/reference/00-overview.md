...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 75-event audit taxonomy |
...
| [State Machine](12-state-machine.md) | Workflow / phase / stage machines, 75-event taxonomy, audit-first rules |
