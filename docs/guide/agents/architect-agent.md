...
| 2.6 Domain Design | Inception | Logical component catalogue (`components.md`): behaviours, dependencies, owned entities, rationale |
| 2.7 Units Generation | Inception | Decomposes the component model into implementable units of work |
| 2.8 Contract Design | Inception | Formalises inter-unit contracts so teams can build in parallel |
