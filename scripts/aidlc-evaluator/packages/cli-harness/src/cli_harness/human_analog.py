...
def generate_human_response(
    ...
    try:
        ...
        # This is critical during A/B evaluations because a backend auth failure
        # would otherwise be masked as a series of "Approve & Continue."
        # responses that produce no meaningful signal.
