...
- **11 domain experts**: Each stage leverages the appropriate agent persona; inline framing loads from `.aidlc/agents/`, while dispatched work targets the native `.github/agents/` roster.
