...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.aidlc/knowledge/aidlc-aws-platform-agent/` for integration-mechanism awareness (sync REST vs. async messaging vs. shared store).
