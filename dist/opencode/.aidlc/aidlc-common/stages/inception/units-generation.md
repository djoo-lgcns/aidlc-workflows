...
Load aidlc-delivery-agent persona from `agents/aidlc-delivery-agent.md` and knowledge from `.aidlc/knowledge/aidlc-delivery-agent/` for feasibility validation and prioritization.
