...
//       "## Event Registry (75 events, 20 categories)" .. "## Hook-Generated"
...
//   .sh test 7 (assert_eq TS_COUNT - baseline pin)    -> "VALID_EVENT_TYPES.size === 75 (baseline pin)"
...
// +PLAN_APPROVAL_BLOCKED (the plan-approval PreToolUse guard) takes it to 75).
const CANONICAL_COUNT = 75;
...
describe("t28 audit event-type sync (migrated from t28-audit-event-sync.sh, plan 7)", () => {
  ...
  // #369 removed TEST_RUN_MODE_ENABLED -> 68; HUMAN_TURN took it to 69; the adaptive composer added RECOMPOSED -> 70; REVIEWER_SCOPE_BLOCKED took it to 71; PLUGIN_SELECTION_CHANGED took it to 72; REVIEW_REQUESTED/REVIEW_COMPLETED took it to 74; PLAN_APPROVAL_BLOCKED took it to 75.)
  test("VALID_EVENT_TYPES.size === 75 (baseline pin) [.sh test 7]", () => {
