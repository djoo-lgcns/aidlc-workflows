...
//          (aidlc-docs/.aidlc-hooks-health/stop.last, aidlc-continue-workflow.ts:90) is
...
//          (aidlc-continue-workflow.ts:370) to .aidlc-hooks-health/stop.drops — a stuck loop
...
//   - heartbeat write:           aidlc-continue-workflow.ts:90 (stop.last)
  ...
  test(
    ...
    () => {
      ...
      try {
        ...
        // pinned; aidlc-continue-workflow.ts:298-307 phrases continuation, never override).
